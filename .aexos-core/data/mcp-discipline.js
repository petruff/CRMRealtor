...
//
// Usage:
//   node .aexos-core/data/mcp-discipline.js --apply     # Disable non-essential
//   node .aexos-core/data/mcp-discipline.js --restore   # Re-enable all
//   node .aexos-core/data/mcp-discipline.js --status    # Show current state
//   node .aexos-core/data/mcp-discipline.js --enable <server>  # Re-enable specific
// =============================================================================
...
const BACKUP_PATH = path.join(PROJECT_ROOT, '.aexos', 'mcp-backup.json');
const CAPABILITIES_PATH = path.join(PROJECT_ROOT, '.aexos', 'runtime-capabilities.json');
