#!/usr/bin/env node
// =============================================================================
// AEXOS Capability Detection Module
// =============================================================================
...
//
// Usage:
//   node .aexos-core/data/capability-detection.js
//
// Output:
//   .aexos/runtime-capabilities.json
// =============================================================================
...
const OUTPUT_PATH = path.join(PROJECT_ROOT, '.aexos', 'runtime-capabilities.json');
...
function loadToolRegistry() {
  const registryPath = path.join(PROJECT_ROOT, '.aexos-core', 'data', 'tool-registry.yaml');
  try {
