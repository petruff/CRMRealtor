# AEXOS Health Dashboard

Visual dashboard for the AEXOS Health Check System. Displays real-time health status, domain scores, issues, and self-healing history.
...
- **Production**: Reads from `.aexos/reports/health-check-latest.json`
...
- [Health Check Core Module](../../.aexos-core/core/health-check/)
- [JSON Reporter](../../.aexos-core/core/health-check/reporters/json.js)

---

_Part of AEXOS-FULLSTACK - Story HCS-2 Phase 4_
