...
/**
 * Test template system for AEXOS (Cyryx) automated test generation
 * Provides reusable templates for generating different types of tests
 */
class TestTemplateSystem {
  constructor(options = {}) {
    this.rootPath = options.rootPath || process.cwd();
    this.templatesDir = path.join(this.rootPath, 'aexos-core', 'templates', 'tests');
  ...
  async generateTestContent(component, testFile, config) {
    ...
    const templateData = {
      ...
      metadata: {
        ...
        generator: 'AEXOS Test Template System',
        version: '1.0.0',
      },
    };
    ...
    return {
      agent: {
        ...
        setup: {
          ...
          beforeEach: [
            "agentPath = path.join(__dirname, '../../../aexos-core/agents/{{component.name}}.md');",
      ...
      task: {
        ...
        setup: {
          ...
          beforeEach: [
            "taskPath = path.join(__dirname, '../../../aexos-core/tasks/{{component.name}}.md');",
      ...
      workflow: {
        ...
        setup: {
          ...
          beforeEach: [
            "workflowPath = path.join(__dirname, '../../../aexos-core/workflows/{{component.name}}.yaml');",
      ...
      util: {
        ...
        setup: {
          ...
          beforeEach: [
            "UtilClass = require('../../../aexos-core/scripts/{{component.name}}');",
...
afterAll(async () => {
  ...
  renderMetadata(metadata, data) {
    return `
// Generated by AEXOS Test Template System
