...
This document provides the standard template structure for AEXOS documentation. All documentation in the AEXOS framework should follow this template to ensure consistency and ease of navigation.
...
_Last Updated: {{DATE}} | AEXOS Framework Team_
```
...
Brief description of what this document covers and its purpose within the AEXOS framework.
...
**Version:** 1.0.0
**Last Updated:** 2026-01-28
**Audience:** Developers extending AEXOS

---

## Overview

This guide explains how to create custom agents for the AEXOS framework.
...
- [AEXOS Framework Documentation](/docs/README.md)
