...
**Agent:** @aexos-master
**Story:** IDS-7 (aexos-master IDS Governor Integration)
...
```bash
node bin/aexos-ids.js ids:check "your intent" --type task
node bin/aexos-ids.js ids:impact create-doc
node bin/aexos-ids.js ids:stats --json
node bin/aexos-ids.js ids:register path/to/file.md
```
...
- `.aexos-core/core/ids/framework-governor.js` — FrameworkGovernor class
- `.aexos-core/core/ids/registry-loader.js` — RegistryLoader
- `.aexos-core/core/ids/incremental-decision-engine.js` — DecisionEngine
- `.aexos-core/core/ids/registry-updater.js` — RegistryUpdater
- `.aexos-core/core/ids/registry-healer.js` — RegistryHealer (optional, IDS-4a)
...
*IDS-7 | Created 2026-02-10 by @dev (Vulcan)*
