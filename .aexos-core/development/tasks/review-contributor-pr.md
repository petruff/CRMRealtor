...
#### For Code PRs (packages/, .aexos-core/, bin/)
...
gh pr diff {pr_number} -- 'packages/' '.aexos-core/' 'bin/' | grep -E "(shell:\s*true|execSync\(|\.exec\(|eval\(|Function\()"
