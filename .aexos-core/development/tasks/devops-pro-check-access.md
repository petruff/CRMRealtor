...
Check whether an email already has AEXOS Pro buyer entitlement and whether an auth account exists.
...
- `POST https://aexos-license-server.vercel.app/api/v1/auth/check-email`
