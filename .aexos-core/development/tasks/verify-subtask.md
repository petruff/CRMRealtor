...
autoClaude:
  ...
  verification:
    type: script
    script: .aexos-core/infrastructure/scripts/subtask-verifier.js
    timeout: 120
```
  ...
  actions:
    - action: find_implementation
      paths:
        ...
        - .aexos/plans/{storyId}/implementation.yaml
...
step_2:
  actions:
    - action: execute_script
      script: |
        node .aexos-core/infrastructure/scripts/subtask-verifier.js {subtaskId} \
