...
Call the live `activate-pro` endpoint directly to validate or restore AEXOS Pro activation for a session.
...
- `POST https://aexos-license-server.vercel.app/api/v1/auth/activate-pro`
