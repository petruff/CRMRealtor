...
Grant, restore, or validate AEXOS Pro access for a customer using the live license server, Supabase Auth, and guided installer validation.
...
- `docs/aexos-workflows/pro-access-grant-workflow.md`
