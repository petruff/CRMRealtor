...
- field: core_config
  type: file
  destination: .aexos-core/core-config.yaml
  persisted: true
...
pre-conditions:
  ...
  - [ ] Documentation Integrity module is available
    ...
    blocker: true
    validation: |
      Verify .aexos-core/infrastructure/scripts/documentation-integrity/index.js exists
...
post-conditions:
  ...
  - [ ] core-config.yaml created with valid deployment section
    ...
    blocker: true
    validation: |
      Verify .aexos-core/core-config.yaml exists and has deployment configuration
...
acceptance-criteria:
  ...
  - [ ] .gitignore properly configured for project
    ...
    blocker: true
    validation: |
      Assert .gitignore includes AEXOS ignores and tech stack ignores
...
- **Tool:** documentation-integrity
  ...
  - **Source:** .aexos-core/infrastructure/scripts/documentation-integrity/index.js

- **Tool:** deployment-config-loader
  - **Purpose:** Load and validate deployment configuration
  - **Source:** .aexos-core/infrastructure/scripts/documentation-integrity/deployment-config-loader.js
...
- **Script:** mode-detector.js
  ...
  - **Language:** JavaScript
  - **Location:** .aexos-core/infrastructure/scripts/documentation-integrity/mode-detector.js

- **Script:** doc-generator.js
  - **Purpose:** Generate project documentation from templates
  - **Language:** JavaScript
  - **Location:** .aexos-core/infrastructure/scripts/documentation-integrity/doc-generator.js

- **Script:** config-generator.js
  - **Purpose:** Generate core-config.yaml
  - **Language:** JavaScript
  - **Location:** .aexos-core/infrastructure/scripts/documentation-integrity/config-generator.js

- **Script:** gitignore-generator.js
  - **Purpose:** Generate or merge .gitignore
  - **Language:** JavaScript
  - **Location:** .aexos-core/infrastructure/scripts/documentation-integrity/gitignore-generator.js
...
```javascript
const { detectInstallationMode, collectMarkers } = require('./.aexos-core/infrastructure/scripts/documentation-integrity');
...
|------|-------------|---------|
| `framework-dev` | Contributing to aexos-core itself | Skip project setup, use existing config |
...
```javascript
const { buildDocContext, generateDocs } = require('./.aexos-core/infrastructure/scripts/documentation-integrity');
...
```javascript
const { buildConfigContext, generateConfig, DeploymentWorkflow, DeploymentPlatform } = require('./.aexos-core/infrastructure/scripts/documentation-integrity');
...
```javascript
const { generateGitignoreFile, hasCyryxIntegration } = require('./.aexos-core/infrastructure/scripts/documentation-integrity');
...
```javascript
const { loadDeploymentConfig, validateDeploymentConfig } = require('./.aexos-core/infrastructure/scripts/documentation-integrity');
