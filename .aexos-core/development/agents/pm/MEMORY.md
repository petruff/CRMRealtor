...
- State tracked in `.aexos/epic-{epicId}-state.yaml`
...
- Session state persistence in `.aexos/bob-session/`

### Key Locations
- PRD: `docs/prd/` (sharded)
- Epics: `docs/stories/epics/`
- Templates: `.aexos-core/development/templates/`
