...
### Project Structure
- `.aexos-core/core/` — Core modules (synapse, session, code-intel, orchestration)
- `.aexos-core/development/` — Agents, tasks, templates, scripts
- `.aexos-core/infrastructure/` — CI/CD, git detection, project-status
...
- atomicWriteSync from `.aexos-core/core/synapse/utils/atomic-write` for safe file writes
