/**
 * Backlog Manager for AEXOS Framework
 *
...
`;
    ...
    markdown += '\n---\n\n';
    markdown += '*Auto-generated by AEXOS Backlog Manager (Story 6.1.2.6)*\n';
    markdown += '*Update: Run `npm run stories:backlog` or `node .aexos-core/scripts/backlog-manager.js generate docs/stories/backlog.md`*\n';
