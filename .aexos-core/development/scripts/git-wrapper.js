...
/**
 * Git operations wrapper for AEXOS framework modifications
 */
class GitWrapper {
  constructor(options = {}) {
  ...
  async commit(message, options = {}) {
    const {
      author = 'aexos-developer <aexos-developer@aexos-squads.local>',
      signoff = true
    } = options;
  ...
  async commitModification(files, message, metadata = {}) {
    ...
    fullMessage += '\n\nGenerated by: aexos-developer meta-agent';
