 ...
 *
 * State files are stored at: .aexos/{instance-id}-state.yaml
 *
 * Design constraints:
...
class WorkflowStateManager {
  ...
  constructor(options = {}) {
    ...
    this.stateDir = path.join(this.basePath, '.aexos');
  }
  ...
  resolveAgentPaths(state) {
    const corePath = path.join(this.basePath, '.aexos-core', 'development', 'agents');
