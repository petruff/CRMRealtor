/**
 * Dependency Analyzer for AEXOS-FULLSTACK
...
class DependencyAnalyzer {
  constructor(options = {}) {
    ...
    this.manifestPath = path.join(this.rootPath, 'aexos-core', 'team-manifest.yaml');
    
    // Component paths
    this.paths = {
      agents: path.join(this.rootPath, 'aexos-core', 'agents'),
      tasks: path.join(this.rootPath, 'aexos-core', 'tasks'),
      workflows: path.join(this.rootPath, 'aexos-core', 'workflows')
    };
