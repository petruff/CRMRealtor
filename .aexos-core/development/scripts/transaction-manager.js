/**
 * Transaction Manager for AEXOS-FULLSTACK
...
class TransactionManager {
  constructor(options = {}) {
    ...
    this.transactionPath = path.join(this.rootPath, 'aexos-core', 'transactions');
    this.backupPath = path.join(this.rootPath, 'aexos-core', 'backups');
  ...
  async rollbackManifestUpdate(operation, results) {
    try {
      const manifestPath = path.join(this.rootPath, 'aexos-core', 'team-manifest.yaml');
