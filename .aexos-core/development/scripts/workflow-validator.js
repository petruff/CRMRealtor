 ...
 * Workflow Validator
 *
 * Validates workflow YAML files against AEXOS workflow conventions:
 * 1. YAML syntax
...
class WorkflowValidator {
  ...
  constructor(options = {}) {
    ...
    this.agentsPath = options.agentsPath || path.join(process.cwd(), '.aexos-core', 'development', 'agents');
