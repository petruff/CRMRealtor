 ...
 *
 * Usage:
 *   node .aexos-core/utils/validate-filenames.js
 *   node .aexos-core/utils/validate-filenames.js --fix
 */
...
class FilenameValidator {
  ...
  report() {
    console.log('\n📋 AEXOS Filename Validation Report\n');
    ...
    if (this.errors.length > 0) {
      ...
      console.log('3. Or run: node .aexos-core/utils/validate-filenames.js --fix\n');
