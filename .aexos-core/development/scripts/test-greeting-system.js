 ...
 * Run: node .aexos-core/scripts/test-greeting-system.js
 */
...
const mockDevAgent = {
  ...
  persona_profile: {
    ...
    zodiac: '♒ Aquarius',
    greeting_levels: {
      minimal: '💻 Vulcan ready',
      named: '💻 Vulcan (Builder) ready. Let\'s build something solid!',
      archetypal: '💻 Vulcan the Builder (♒ Aquarius) ready to construct excellence!',
    },
  },
  persona: {
...
const mockPoAgent = {
  ...
  persona_profile: {
    ...
    zodiac: '♎ Libra',
    greeting_levels: {
      minimal: '⚖️ Themis ready',
      named: '⚖️ Themis (Balancer) ready. Let\'s prioritize together!',
      archetypal: '⚖️ Themis the Balancer (♎ Libra) ready to harmonize requirements!',
    },
  },
  persona: {
