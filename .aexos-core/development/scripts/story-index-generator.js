/**
 * Story Index Generator for AEXOS Framework
 *
...
`;
  ...
  markdown += '\n---\n\n';
  markdown += '*Auto-generated by AEXOS Story Index Generator (Story 6.1.2.6)*\n';
  markdown += '*Update: Run `npm run stories:index` or `node .aexos-core/scripts/story-index-generator.js docs/stories`*\n';
