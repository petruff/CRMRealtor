 ...
 *
 * Analyzes all 13 AEXOS agents to determine which core-config.yaml sections
...
async function extractAgentDependencies(agentId) {
  const agentPath = path.join('.aexos-core', 'agents', `${agentId}.md`);
...
function analyzeConfigNeeds(agentData) {
  ...
  if (agentData.agentId === 'aexos-master' ||
...
*Auto-generated by AEXOS Agent Config Audit (Story 6.1.2.6)*
`;
...
async function auditAllAgents() {
  console.log('🔍 Auditing all 13 AEXOS agents...\n');
