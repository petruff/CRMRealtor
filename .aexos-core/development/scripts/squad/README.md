...
Utilities for the squad-creator agent to manage squads in AEXOS projects.
...
# Run with coverage
npm test -- tests/unit/squad/squad-loader.test.js --coverage --collectCoverageFrom=".aexos-core/development/scripts/squad/*.js"
```
