 ...
 * - AC2: Generates `.aexos/gotchas.md` consolidated
...
const CONFIG = {
  ...
  outputJsonPath: '.aexos/gotchas.json',
  ...
  // Schema version
  schemaVersion: 'aexos-gotchas-v1',
};
...
*Generated by AEXOS Gotchas Documenter v${CONFIG.version}*
`;
  ...
  static showHelp() {
    console.log(`
Gotchas Documenter - AEXOS Memory Layer (Story 7.4)
