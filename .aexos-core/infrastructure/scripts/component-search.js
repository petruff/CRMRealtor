...
/**
 * Component search utility for AEXOS (Cyryx) framework
...
class ComponentSearch {
  ...
  async searchComponent(componentType, componentName) {
    ...
    const searchPaths = [
      path.join(this.rootPath, 'aexos-core', typeConfig.directory),
  ...
  async findRegistrationFile(componentType, componentName) {
    const possibleRegistrationFiles = [
      path.join(this.rootPath, 'aexos-core', 'registry.json'),
