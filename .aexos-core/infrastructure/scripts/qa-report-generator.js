...
const CONFIG = {
  ...
  // Template path
  templatePath: '.aexos-core/product/templates/qa-report-tmpl.md',
...
class QAReportGenerator {
  ...
  constructor(storyId, options = {}) {
    ...
    this.agentName = options.agentName || 'Argus (QA Guardian)';
...
*Generated by AEXOS QA Report Generator v1.0*
`;
  }
...
async function main() {
  ...
  if (args.length < 1 || args.includes('--help') || args.includes('-h')) {
    console.log(`
QA Report Generator - AEXOS QA Evolution (Story 6.2)
