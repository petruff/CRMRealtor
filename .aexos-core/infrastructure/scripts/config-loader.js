 ...
 * 
 * AEXOS Config Loader with Lazy Loading
 *
...
const agentRequirements = {
  ...
  'aexos-master': ['frameworkDocsLocation', 'projectDocsLocation', 'devLoadAlwaysFiles', 'lazyLoading', 'registry', 'expansionPacks', 'toolConfigurations'],
...
async function loadFullConfig() {
  const configPath = path.join('.aexos-core', 'core-config.yaml');
