 ...
 *
 * Writes the current AEXOS agent status to .aexos/dashboard/status.json
...
const STATUS_DIR = '.aexos/dashboard';
 ...
 * Uses AEXOS_PROJECT_ROOT env var or cwd
 */
function getProjectRoot() {
  return process.env.AEXOS_PROJECT_ROOT || process.cwd();
}
