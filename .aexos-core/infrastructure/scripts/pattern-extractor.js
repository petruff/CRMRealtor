...
\`\`\``,
  ...
  async savePatterns(outputPath) {
    const defaultPath = path.join(this.rootPath, '.aexos', 'patterns.md');
...
`);
  ...
  // Find project root (look for package.json or .aexos-core)
