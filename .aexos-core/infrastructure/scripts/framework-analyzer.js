...
/**
 * Framework structure analyzer for AEXOS (Cyryx)
 * Discovers and catalogs all framework components
 */
class FrameworkAnalyzer {
  constructor(options = {}) {
    this.rootPath = options.rootPath || process.cwd();
    this.cyryxCoreDir = path.join(this.rootPath, 'aexos-core');
  ...
  async discoverAgents() {
    const agents = [];
    const agentsDir = path.join(this.cyryxCoreDir, 'agents');
  ...
  async discoverTasks() {
    const tasks = [];
    const tasksDir = path.join(this.cyryxCoreDir, 'tasks');
  ...
  async discoverWorkflows() {
    const workflows = [];
    const workflowsDir = path.join(this.cyryxCoreDir, 'workflows');
  ...
  async discoverUtils() {
    const utils = [];
    const utilsDir = path.join(this.cyryxCoreDir, 'utils');
  ...
  async discoverTemplates() {
    const templates = [];
    const templatesDir = path.join(this.cyryxCoreDir, 'templates');
