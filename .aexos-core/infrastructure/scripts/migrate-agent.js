...
/**
 * AEXOS Agent Migration Script (V2 → V3)
...
// Paths
const AGENTS_DIR = '.aexos-core/development/agents';
const BACKUP_DIR = '.aexos/migration-backup';
const SCHEMAS_DIR = '.aexos-core/schemas';
...
function formatListOutput(agents) {
  ...
  lines.push('');
  lines.push('═══════════════════════════════════════════════════════════');
  lines.push('  AEXOS Agents - Migration Status');
  lines.push('═══════════════════════════════════════════════════════════');
  lines.push('');
