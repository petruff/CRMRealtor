 ...
 * @property {string} [worktreeDir='.aexos/worktrees'] - Directory for worktrees
 ...
 * @property {string} [mergeLogDir='.aexos/logs/merges'] - Directory for merge audit logs
 */
...
class WorktreeManager {
  ...
  constructor(projectRoot, options = {}) {
    ...
    this.worktreeDir = options.worktreeDir || '.aexos/worktrees';
    this.branchPrefix = options.branchPrefix || 'auto-claude/';
    this.staleDays = options.staleDays || 30;
    this.mergeLogDir = options.mergeLogDir || '.aexos/logs/merges';
    this.gitPath = 'git';
  }
