 ...
 * @location .aexos-core/infrastructure/scripts/llm-routing/usage-tracker/
 */
...
const DATA_DIR = path.join(os.homedir(), '.aexos', 'usage-tracking');
...
║  Data File:    ~/.aexos/usage-tracking/deepseek-usage.json  ║
╠════════════════════════════════════════════════════════════╣
║  Endpoints:                                                ║
║    /health     - Health check                              ║
