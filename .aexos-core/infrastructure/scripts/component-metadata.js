/**
 * Component Metadata Manager for AEXOS (Cyryx)
...
class ComponentMetadata {
  constructor(options = {}) {
    ...
    this.metadataPath = path.join(this.rootPath, 'aexos-core', 'metadata');

    // Initialize memory adapter if available
    this.memoryClient = MemoryAdapter ? new MemoryAdapter({
      persistencePath: path.join(this.rootPath, 'aexos-memory-layer-mvp', 'data'),
