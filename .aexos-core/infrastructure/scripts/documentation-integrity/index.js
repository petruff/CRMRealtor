 ...
 *
 * Mode-aware project configuration system for AEXOS.
...
module.exports = {
  ...
  isCyryxCoreRepository: modeDetector.isCyryxCoreRepository,
  ...
  hasCyryxIntegration: gitignoreGenerator.hasCyryxIntegration,
