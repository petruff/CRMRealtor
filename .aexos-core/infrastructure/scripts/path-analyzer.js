...
const REFERENCE_PATTERNS = [
  // Markdown code refs to .aexos-core
  { pattern: /`\.aexos-core\/[^`]+`/g, type: 'code-ref' },
  // Task references
...
const ASSET_DIRS = {
  task: '.aexos-core/development/tasks',
  template: '.aexos-core/product/templates',
  checklist: '.aexos-core/product/checklists',
  script: '.aexos-core/infrastructure/scripts',
  data: '.aexos-core/development/data',
  schema: '.aexos-core/schemas',
  agent: '.aexos-core/development/agents',
};
...
async function findFilesToAnalyze(rootPath) {
  const files = [];
  const dirsToScan = [
    { dir: '.aexos-core/development/agents', type: 'agent' },
    { dir: '.aexos-core/development/tasks', type: 'task' },
    { dir: '.aexos-core/product/templates', type: 'template' },
    { dir: '.aexos-core/product/checklists', type: 'checklist' },
  ];
...
function resolveReference(ref, rootPath) {
  ...
  if (ref.reference.startsWith('.aexos-core/')) {
...
function formatConsoleOutput(report, verbose = false) {
  ...
  lines.push('');
  lines.push('═══════════════════════════════════════════════════════════');
  lines.push('  AEXOS Path Analysis Report');
