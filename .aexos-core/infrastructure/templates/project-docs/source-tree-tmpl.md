...
> **Auto-generated by AEXOS** on {{GENERATED_DATE}}
...
```
{{PROJECT_NAME}}/
├── .aexos-core/                    # AEXOS configuration
...
|------|----------|---------|
| `.aexos-core/core-config.yaml` | Root | AEXOS configuration |
...
*Generated by AEXOS Documentation Integrity System*
