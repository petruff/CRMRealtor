...
Project Management tool adapters for AEXOS. Enables story synchronization with various PM tools.
...
PM tool is configured via `.aexos-pm-config.yaml` in the project root:
