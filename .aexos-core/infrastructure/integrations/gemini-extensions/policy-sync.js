...
class PolicySync {
  ...
  /**
   * Get AEXOS permission policies
   */
  async getCYRYXPolicies() {
    const policiesPath = path.join(this.projectDir, '.aexos', 'policies.json');
  ...
  async exportToGemini() {
    const policies = await this.getCYRYXPolicies();
