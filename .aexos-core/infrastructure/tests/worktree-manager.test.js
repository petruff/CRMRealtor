...
describe('WorktreeManager', () => {
  ...
  beforeEach(async () => {
    ...
    testRoot = await fs.mkdtemp(path.join(os.tmpdir(), 'aexos-worktree-test-'));
  ...
  describe('constructor', () => {
    it('should use default options when none provided', () => {
      ...
      expect(defaultManager.worktreeDir).toBe('.aexos/worktrees');
  ...
  describe('getWorktreePath', () => {
    it('should return correct path for story', () => {
      ...
      expect(wtPath).toBe(path.join(testRoot, '.aexos/worktrees', 'STORY-42'));
    });
  });
