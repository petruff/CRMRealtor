 ...
 *
 * Implements `aexos workers list` CLI command.
...
Examples:
  $ aexos workers list
  $ aexos workers list --category=task
  $ aexos workers list --format=table
  $ aexos workers list --format=json --category=script
  $ aexos workers list --page=2 --limit=10
  $ aexos workers list --count
  $ aexos workers list --verbose
