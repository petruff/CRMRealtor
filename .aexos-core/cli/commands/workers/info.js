 ...
 *
 * Implements `aexos workers info <id>` CLI command.
...
function createInfoCommand() {
  ...
  info
    ...
    .addHelpText('after', `
Examples:
  $ aexos workers info json-csv-transformer
  $ aexos workers info architect-checklist --format=json
  $ aexos workers info create-story --format=yaml
  $ aexos workers info data-analyzer --verbose
