 ...
 *
 * Implements `aexos workers search <query>` CLI command.
...
Examples:
  ...
  $ aexos workers search "data transformation" --category=etl
  $ aexos workers search "validation" --tags=schema,json
  $ aexos workers search "api" --format=json --limit=5
  $ aexos workers search "transform" --semantic
  $ aexos workers search "convert" --keyword
`)
