...
Examples:
  $ aexos qa run                    Run full pipeline
  $ aexos qa run --layer=1          Run only Layer 1 (pre-commit)
  $ aexos qa run --layer=2          Run only Layer 2 (PR automation)
  $ aexos qa run --verbose          Run with detailed output
  $ aexos qa status                 Show current gate status
