 ...
 * MCP Setup Command
 *
 * Creates the global ~/.aexos/mcp/ directory structure.
 *
...
function createSetupCommand() {
  ...
  setup
    .description('Create global MCP configuration structure at ~/.aexos/')
...
async function executeSetup(options) {
  ...
  console.log('\nNext steps:');
  console.log('  1. Run "aexos mcp link" in your project to use global config');
  console.log('  2. Run "aexos mcp add <server>" to add more servers');
  console.log('  3. Run "aexos mcp status" to check configuration');
