...
Data Storage:
  Metrics are stored in .aexos/data/quality-metrics.json
...
Examples:
  $ aexos metrics record --layer 1 --passed --duration 3200
  $ aexos metrics record --layer 2 --passed --findings 3 --coderabbit
  $ aexos metrics show
  $ aexos metrics show --layer 2
  $ aexos metrics show --format json
  $ aexos metrics seed --days 30
  $ aexos metrics cleanup
  $ aexos metrics cleanup --dry-run
`);
