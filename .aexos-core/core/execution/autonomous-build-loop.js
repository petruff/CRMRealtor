 ...
 * Inspired by Auto-Claude's Coder Agent but with AEXOS extensibility.
 *
 * Features:
 * - AC1: Located in `.aexos-core/core/execution/`
...
async function main() {
  ...
  if (args.length === 0 || args.includes('--help') || args.includes('-h')) {
    console.log(`
${chalk.bold('Autonomous Build Loop')} - AEXOS Coder Agent Loop (Story 8.1)
