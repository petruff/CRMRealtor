// PRO-UX.1 / PRO-UX.2 — Pro-specific error registry for the AEXOS Pro CLI.
// Extends the canonical error-governance infra (EPIC-AEXOS-ERROR-GOVERNANCE):
// reuses CYRYXError + ErrorRegistry, maps to EXISTING ErrorCategory values
// (no new categories — constants.js is Object.freeze), and mirrors the
// license-server ErrorCodes (no AEXOS_ prefix — deliberate, validated by the
...
const PRO_ERROR_DEFINITIONS = Object.freeze([
  ...
  },
  {
    ...
    recovery: [
      ...
      'Roda `aexos install --recover-cache` para limpar o cache local',
      'Tenta de novo',
    ],
  },
]);
