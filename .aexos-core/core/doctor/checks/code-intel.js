 ...
 *
 * @module aexos-core/doctor/checks/code-intel
...
async function run(context) {
  const codeIntelDir = path.join(context.projectRoot, '.aexos-core', 'core', 'code-intel');
    ...
    if (!available) {
      ...
      if (fs.existsSync(registryPath)) {
        ...
        return {
          ...
          fixCommand: 'node .aexos-core/development/scripts/populate-entity-registry.js',
        };
      }
