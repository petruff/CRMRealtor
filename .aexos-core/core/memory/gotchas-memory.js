 ...
 *
 * Features:
 * - AC1: gotchas-memory.js in .aexos-core/core/memory/
 * - AC2: Persists in .aexos/gotchas.json and .aexos/gotchas.md
...
const CONFIG = {
  // Output paths
  gotchasJsonPath: '.aexos/gotchas.json',
  gotchasMdPath: '.aexos/gotchas.md',
  errorTrackingPath: '.aexos/error-tracking.json',
  ...
  // Version
  version: '1.0.0',
  schemaVersion: 'aexos-gotchas-memory-v1',
};
...
> Auto-generated by AEXOS Gotchas Memory
> Last updated: ${now}
...
*Generated by AEXOS Gotchas Memory v${CONFIG.version}*
`;
  ...
  static showHelp() {
    console.log(`
Gotchas Memory - AEXOS Memory Layer (Story 9.4)
