...
This guide walks you through creating components in AEXOS (Cyryx) using the meta-agent's enhanced template system and interactive workflows.
...
1. **Check component examples**: `.aexos-core/development/agents/examples/`
2. **Review templates**: `.aexos-core/product/templates/`
...
Create custom templates in `.aexos-core/product/templates/custom/`:
