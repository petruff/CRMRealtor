...
AEXOS (Cyryx) now automatically translates Portuguese documentation into English filenames when sharding documents. This ensures consistency across all projects and compatibility with hardcoded English filenames in configuration files.
...
**See full dictionary:** `.aexos-core/tasks/shard-doc.md` (Section 3)
...
**Configuration:** `.aexos-core/core-config.yaml`
...
```bash
# Check for issues
node .aexos-core/scripts/validate-filenames.js

# Auto-fix issues (renames files)
node .aexos-core/scripts/validate-filenames.js --fix
```
...
Edit `.aexos-core/tasks/shard-doc.md`, Section 3:
...
**Solution:**
1. Check you're using the updated `.aexos-core/tasks/shard-doc.md`
2. Run validator to confirm: `node .aexos-core/scripts/validate-filenames.js`
...
**Manual fix:**
Edit `.aexos-core/core-config.yaml` to add more fallbacks.
...
```javascript
// .aexos-core/scripts/validate-filenames.js
...
A: Edit `.aexos-core/tasks/shard-doc.md`, Section 3, and add to the YAML dictionary.
...
2. Run the validator: `node .aexos-core/scripts/validate-filenames.js`
3. Review `.aexos-core/tasks/shard-doc.md` for translation rules
