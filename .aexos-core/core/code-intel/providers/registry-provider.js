 ...
 * Data source: .aexos-core/data/entity-registry.yaml (737+ entities, 14 categories).
 *
...
class RegistryProvider extends CodeIntelProvider {
  ...
  _resolveRegistryPath() {
    ...
    const defaultPath = path.join(projectRoot, '.aexos-core', 'data', 'entity-registry.yaml');
