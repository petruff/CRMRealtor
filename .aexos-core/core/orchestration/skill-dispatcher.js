/**
 * Skill Dispatcher - Dispatches to AEXOS Skills instead of generic Task calls
 *
 ...
 *
 * Responsibilities:
 * - Map agent IDs to AEXOS Skill names
 ...
 * @property {string} skill - Full skill name (e.g., 'AEXOS:agents:architect')
...
/**
 * Dispatches workflow phases to AEXOS Skills
 */
/**
...
class SkillDispatcher {
  ...
  constructor(options = {}) {
     ...
     * These correspond to files in .claude/commands/AEXOS/agents/
     */
    this.skillMapping = {
      // Core development agents
      architect: 'AEXOS:agents:architect',
      'data-engineer': 'AEXOS:agents:data-engineer',
      dev: 'AEXOS:agents:dev',
      qa: 'AEXOS:agents:qa',
      ...
      po: 'AEXOS:agents:po',
      sm: 'AEXOS:agents:sm',
      analyst: 'AEXOS:agents:analyst',

      // Specialized agents
      'ux-design-expert': 'AEXOS:agents:ux-design-expert',
      'ux-expert': 'AEXOS:agents:ux-design-expert', // Alias
      devops: 'AEXOS:agents:devops',
      'github-devops': 'AEXOS:agents:devops', // Alias

      // Master agent
      'aexos-master': 'AEXOS:agents:aexos-master',
    };
     ...
     */
    this.agentPersonas = {
      architect: { name: 'Vega', title: 'System Architect' },
      'data-engineer': { name: 'Ceres', title: 'Database Architect' },
      dev: { name: 'Vulcan', title: 'Senior Developer' },
      qa: { name: 'Argus', title: 'QA Guardian' },
      ...
      devops: { name: 'Polaris', title: 'DevOps Engineer' },
      'aexos-master': { name: 'Zeus', title: 'Master Orchestrator' },
    };
  }
   ...
   * @returns {string} Full skill name (e.g., 'AEXOS:agents:architect')
   */
  getSkillName(agentId) {
    return this.skillMapping[agentId] || `AEXOS:agents:${agentId}`;
  }
  ...
  getAgentPersona(agentId) {
    return (
      this.agentPersonas[agentId] || { name: agentId, title: 'AEXOS Agent' }
    );
  }
  ...
  isValidAgent(agentId) {
    return agentId in this.skillMapping || agentId.startsWith('AEXOS:');
  }
}
