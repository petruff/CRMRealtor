...
async function orchestrate(storyId, options = {}) {
  ...
  console.log(chalk.cyan.bold(`  🚀 AEXOS Orchestrator: ${storyId}`));
  console.log(chalk.cyan('═══════════════════════════════════════════════════════════\n'));
  ...
  try {
    ...
    // Stop dashboard
    await orchestrator.stopDashboard();
...
async function orchestrateStatus(storyId, options = {}) {
  ...
  const statePath = path.join(projectRoot, '.aexos', 'master-orchestrator', `${storyId}.json`);
