 ...
 * - Session states older than 30 days (archived to .aexos/archive/sessions/)
...
const ARCHIVE_DIR = '.aexos/archive/sessions';
const SNAPSHOTS_DIR = '.aexos/snapshots';
...
class DataLifecycleManager {
   ...
   *
   * Sessions with last_updated > 30 days are moved to .aexos/archive/sessions/
   *
