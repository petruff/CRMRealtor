 ...
 *
 * Provides comprehensive health checking capabilities for AEXOS projects.
 ...
 * The primary diagnostic interface is `aexos doctor` (bin/aexos.js → core/doctor/).
 * The agent-facing task `*health-check` now delegates to `aexos doctor --json`
 ...
 *
 * @module aexos-core/health-check
 * @version 1.0.0
