 ...
 *
 * @module aexos-core/health-check/checks/project/workflow-dependencies
 * @version 1.0.0
...
class WorkflowDependenciesCheck extends BaseCheck {
  constructor() {
    super({
      ...
      cacheable: true,
      healingTier: 0,
      tags: ['cyryx', 'workflows', 'dependencies'],
    });
  }
  ...
  async execute(context) {
    ...
    const workflowPaths = [
      path.join(projectRoot, '.aexos-core', 'development', 'workflows'),
      path.join(projectRoot, '.aexos-core', 'infrastructure', 'workflows'),
    ];
    ...
    const taskPaths = [
      path.join(projectRoot, '.aexos-core', 'development', 'tasks'),
      path.join(projectRoot, '.aexos-core', 'infrastructure', 'tasks'),
    ];
