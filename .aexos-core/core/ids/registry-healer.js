...
const HEALING_LOG_PATH = path.resolve(REPO_ROOT, '.aexos-core/data/registry-healing-log.jsonl');
const HEALING_BACKUP_DIR = path.resolve(REPO_ROOT, '.aexos-core/data/registry-backups/healing');
...
class RegistryHealer {
   ...
   * Integrates with AEXOS NotificationManager (console + file channels).
   *
    ...
    switch (issue.ruleId) {
      ...
      default:
        return [
          ...
          'Run \'cyryx ids:health --fix\' after resolving',
        ];
    }
  }
