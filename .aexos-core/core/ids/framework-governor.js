 ...
 *
 * Facade class that integrates aexos-master with the IDS Entity Registry for
 ...
 *   const { RegistryUpdater } = require('.aexos-core/core/ids/registry-updater');
 *   const { FrameworkGovernor } = require('.aexos-core/core/ids/framework-governor');
 *
  ...
  async postRegister(filePath, metadata = {}) {
    ...
    return this._withTimeout(async () => {
      const task = {
        ...
        agent: metadata.agent || 'aexos-master',
