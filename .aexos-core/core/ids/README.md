...
The Entity Registry is the central data store for the Incremental Development System (IDS). It tracks all AEXOS framework artifacts — tasks, templates, scripts, modules, agents, checklists, and data files — with metadata, relationships, adaptability scores, and checksums.

## Schema

The registry is stored at `.aexos-core/data/entity-registry.yaml` as a single YAML file.
...
categories:
  - id: "tasks"
    ...
    basePath: ".aexos-core/development/tasks"
```
...
```bash
node .aexos-core/development/scripts/populate-entity-registry.js
```
