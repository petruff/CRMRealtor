 ...
 */
const DEFAULT_CONFIG_PATH = '.aexos-core/core/quality-gates/quality-gate-config.yaml';
...
class QualityGateManager {
   ...
   */
  async getStatus() {
    const statusPath = this.config.status?.location || '.aexos/qa-status.json';
  ...
  async saveReport(storyId = 'unknown') {
    const reportDir = this.config.reports?.location || '.aexos/qa-reports';
