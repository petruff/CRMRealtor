...
- **Builder (Vulcan):** "✅ Tá pronto! Implementei todas as funcionalidades."
- **Guardian (Argus):** "✅ Validado com rigor. 47 edge cases testados."
- **Balancer (Themis):** "✅ Story completa. Equilibrei performance vs. legibilidade."
...
**Example:**
```markdown
💻 Vulcan (Builder): Preciso saber qual approach você prefere.
...
**Tasks:**
- `.aexos-core/tasks/{dependency1}.md`
- `.aexos-core/tasks/{dependency2}.md`

**Templates:**
- `.aexos-core/product/templates/{template1}.yaml`

**Checklists:**
- `.aexos-core/product/checklists/{checklist1}.md`
...
All task outputs MUST use this structure (see `.aexos-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md`):
...
- See `.aexos-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md` for complete guidelines
