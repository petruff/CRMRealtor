...
2. All tests pass
3. Execute `.aexos-core/product/checklists/story-dod-checklist.md`
...
node .aexos-core/scripts/validate-checklist.js {checklist-id}
  ...
  checklist-validation:
    ...
    steps:
      ...
      - name: Generate Report
        run: |
          node .aexos-core/scripts/generate-checklist-report.js {checklist-id}
...
- **Standard:** `.aexos-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md`
- **Agent File:** `.aexos-core/agents/{agent-id}.md`
...
**Examples:**
- **Vulcan (Builder):** "Checklists são blueprints. Siga-os à risca e construa com confiança. 🔨"
- **Argus (Guardian):** "Cada item é uma proteção. Não pule nenhum. Sua segurança depende disso. 🛡️"
- **Themis (Balancer):** "Use bom senso. Checklist é guia, não prisão. Adapte ao contexto. ⚖️"
