...
This template defines the canonical activation-instructions format for AEXOS agents after GreetingBuilder integration (Story 6.1.2.5).
...
activation-instructions:
  ...
  - STEP 3: Build intelligent greeting using .aexos-core/development/scripts/greeting-builder.js
...
```yaml
- STEP 2.5: Load project status using .aexos-core/infrastructure/scripts/project-status-loader.js
- STEP 2.6: Load session context using .aexos-core/scripts/session-context-loader.js
...
- ✅ Minimal greeting (e.g., "🎯 Themis ready")
...
- **GreetingBuilder**: `.aexos-core/development/scripts/greeting-builder.js`
- **Context Detector**: `.aexos-core/core/session/context-detector.js`
- **Git Config Detector**: `.aexos-core/infrastructure/scripts/git-config-detector.js`
- **Workflow Navigator**: `.aexos-core/development/scripts/workflow-navigator.js`
- **Project Status Loader**: `.aexos-core/infrastructure/scripts/project-status-loader.js`
- **Workflow Patterns**: `.aexos-core/data/workflow-patterns.yaml`
...
*Template maintained by AEXOS Framework Team*
