...
**Version:** 2.1.0
**Date:** 2025-12-09
**Purpose:** Document differences between AEXOS open-source and AEXOS service implementations
...
AEXOS has two deployment contexts:
...
|------------|---------|------|----------|
| `CyryxLabs/AEXOS` | Commons Clause | Public | Core framework, 11 agents, Quality Gates |
| `CyryxLabs/aexos-squads` | MIT | Public | ETL, Creator, MMOS-Mapper squads |
| `CyryxLabs/mcp-ecosystem` | Apache 2.0 | Public | Docker MCP, IDE configs, MCP presets |
| `CyryxLabs/mmos` | Proprietary + NDA | Private | MMOS Minds, DNA Mental |
| `CyryxLabs/certified-partners` | Proprietary | Private | Premium squads, partner portal |

### npm Package Scoping

| Package | Registry | Availability |
|---------|----------|--------------|
| `@cyryx/core` | npm public | Open-source |
| `@cyryx/squad-etl` | npm public | Open-source |
| `@cyryx/squad-creator` | npm public | Open-source |
| `@cyryx/squad-mmos` | npm public | Open-source |
| `@cyryx/mcp-presets` | npm public | Open-source |
...
│                                                                         │
│   CyryxLabs/AEXOS        CyryxLabs/aexos-squads                        │
│   ┌─────────────────────┐     ┌─────────────────────┐                  │
...
│                                                                         │
│   CyryxLabs/mmos             CyryxLabs/certified-partners            │
│   ┌─────────────────────┐     ┌─────────────────────┐                  │
...
```yaml
**Template:**
- path: .aexos-core/templates/task-execution-report.md
  type: output
  version: 1.0
...
**Difference:**
- Open-source uses templates from `.aexos-core/templates/`
...
.aexos-core/checklists/{agent-id}-general-validation.md
```
...
- `.aexos-core/scripts/{agent-id}-specific/{script}.js`
...
**Scripts:**
- .aexos-core/scripts/dev-specific/test-runner.js:    # Only dev uses this
...
- Missing template → Use generic template from `.aexos-core/templates/`
...
- fallback: |
    ...
    1. Check .aexos-core/templates/ for generic version
...
**Agent Personas:**
- Defined in `.aexos-core/agents/{agent-id}.md`
...
- [ ] Update template paths (squads/ → .aexos-core/templates)
...
| **Templates** | .aexos-core/templates/ | squads/{squad}/ |
...
- [AEXOS-LIVRO-DE-OURO-V2.1-COMPLETE.md](./AEXOS-LIVRO-DE-OURO-V2.1-COMPLETE.md) - Complete v4.2 framework guide
...
| 2025-12-09 | 2.1.0 | Added Multi-Repo Strategy section, updated terminology (Squad), updated related docs | @dev (Vulcan) |

---

**Last Updated:** 2025-12-09
**Version:** 2.1.0
**Applies to:** AEXOS v4.2+
