---
paths:
  - .aexos-core/data/tool-registry.yaml
  - .mcp.json
---
...
configuration defined in `.aexos-core/data/tool-registry.yaml` for the tool that
...
`.aexos-core/utils/filters/` are available for batch post-processing of
