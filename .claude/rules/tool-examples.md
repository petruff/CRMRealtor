...
- **Pre-commit:** `wsl bash -c 'cd /mnt/c/.../aexos-core && ~/.local/bin/coderabbit --prompt-only -t uncommitted'`
- **Pre-PR:** `wsl bash -c 'cd /mnt/c/.../aexos-core && ~/.local/bin/coderabbit --prompt-only --base main'`
...
Full examples registry: `.aexos-core/data/mcp-tool-examples.yaml`
Tool registry: `.aexos-core/data/tool-registry.yaml`
