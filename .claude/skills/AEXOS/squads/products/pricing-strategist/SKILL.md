---
name: aexos-products-pricing-strategist
description: "Activate Assay (pricing-strategist) for Pricing Strategist. Use to run the willingness-to-pay conversation BEFORE a product is built, to segment customers by value rather than by demographics, to design packaging and Good/Better/Best con..."
user-invocable: true
