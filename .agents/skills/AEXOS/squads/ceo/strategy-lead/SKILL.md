---
name: aexos-ceo-strategy-lead
description: "Activate Kernel (strategy-lead) for Strategy Lead. Use to build or repair a strategy: naming the actual challenge, choosing an approach to it, and specifying the coordinated actions that carry the approach out. Use to detect bad strategy..."
user-invocable: true
