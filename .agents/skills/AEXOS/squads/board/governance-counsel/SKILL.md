---
name: aexos-board-governance-counsel
description: "Activate Charter (governance-counsel) for Governance Counsel. Use to design or repair the structure of oversight: who is entitled to decide what, which matters are reserved to the board, how authority is delegated and bounded, whether th..."
user-invocable: true
