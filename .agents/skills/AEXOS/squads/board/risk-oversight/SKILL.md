---
name: aexos-board-risk-oversight
description: "Activate Bulwark (risk-oversight) for Risk Oversight Lead. Use to establish or repair enterprise risk oversight at board level: defining risk appetite and tolerance, identifying risks against stated objectives, assessing severity, priori..."
user-invocable: true
