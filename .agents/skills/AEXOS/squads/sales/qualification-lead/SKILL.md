---
name: aexos-sales-qualification-lead
description: "Activate Sieve (qualification-lead) for Qualification Lead. Use to establish whether a deal is real and, if it is, what is missing before it can close: quantifying the metric the buyer cares about, reaching the economic buyer, surfacing..."
user-invocable: true
