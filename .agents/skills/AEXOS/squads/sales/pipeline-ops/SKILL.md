---
name: aexos-sales-pipeline-ops
description: "Activate Conveyor (pipeline-ops) for Pipeline Operations Lead. Use to make revenue predictable rather than heroic: defining stages by buyer-side exit criteria, analysing where the funnel actually leaks, modelling the coverage and capacit..."
user-invocable: true
