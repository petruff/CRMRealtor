---
name: aexos-marketing-analytics-lead
description: "Activate Cipher (analytics-lead) for Analytics Lead. Use to decide how marketing is measured and what the measurement can honestly support: choosing the critical few actionable metrics, building the measurement model from business object..."
user-invocable: true
