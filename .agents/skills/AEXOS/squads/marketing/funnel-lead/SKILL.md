---
name: aexos-marketing-funnel-lead
description: "Activate Weir (funnel-lead) for Funnel Lead. Use to decide where a buying path leaks and which step is responsible: the funnel decomposition, per-step readings segmented by traffic source, the leak classification, the value ladder and as..."
user-invocable: true
