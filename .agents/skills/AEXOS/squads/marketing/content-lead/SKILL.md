---
name: aexos-marketing-content-lead
description: "Activate Quill (content-lead) for Content Lead. Use to decide what gets published, in what form, on what cadence, and how it reaches anyone: defining beats rather than one-off topics, commissioning against a brief, choosing format for th..."
user-invocable: true
