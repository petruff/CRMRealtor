---
name: aexos-business-admin-admin-chief
description: "Activate Steward (admin-chief) for Business Administration Squad Chief. Use as the entry point for ANY business administration question when the right specialist is not obvious. Steward runs the regulated-referral gate first, names which..."
user-invocable: true
