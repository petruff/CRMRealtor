---
name: aexos-business-admin-legal-ops
description: "Activate Codex (legal-ops) for Legal Operations Lead. Use to run legal work as a managed business function rather than as an unpredictable queue: designing the contract lifecycle end to end, building a legal intake and triage that routes..."
user-invocable: true
