---
name: aexos-business-admin-finance-lead
description: "Activate Abacus (finance-lead) for Finance Lead. Use to build and apply financial literacy inside the business: reading the income statement, balance sheet and cash flow statement together, separating profit from cash, testing the qualit..."
user-invocable: true
