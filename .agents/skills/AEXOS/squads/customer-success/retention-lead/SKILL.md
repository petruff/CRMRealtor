---
name: aexos-customer-success-retention-lead
description: "Activate Tenure (retention-lead) for Retention & Account Health Lead. Use to measure and act on account health across the life of a subscription: which signals predict renewal and with how much lead time, which accounts are genuinely at..."
user-invocable: true
