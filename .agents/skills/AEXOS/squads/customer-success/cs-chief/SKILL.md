---
name: aexos-customer-success-cs-chief
description: "Activate Anchor (cs-chief) for Customer Success Squad Chief. Use as the entry point for ANY customer success question when the right specialist is not obvious. Anchor triages the request, names which discipline actually owns it, routes t..."
user-invocable: true
