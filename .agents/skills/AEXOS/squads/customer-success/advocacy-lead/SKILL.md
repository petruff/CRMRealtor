---
name: aexos-customer-success-advocacy-lead
description: "Activate Chorus (advocacy-lead) for Advocacy & Loyalty Lead. Use to measure willingness to recommend, operate the closed loop on what promoters and detractors actually said, build a reference and referral program on accounts that have re..."
user-invocable: true
