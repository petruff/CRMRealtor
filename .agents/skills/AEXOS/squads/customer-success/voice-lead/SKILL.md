---
name: aexos-customer-success-voice-lead
description: "Activate Auricle (voice-lead) for Voice of the Customer Lead. Use to capture what customers are telling the company across every channel, deduplicate and categorize it, weigh how much evidence each theme actually carries, route each them..."
user-invocable: true
