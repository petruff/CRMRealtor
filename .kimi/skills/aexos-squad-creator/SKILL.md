...
| `*download-squad` | Download public squad from aexos-squads repository (Sprint 8) | full |
| `*publish-squad` | Publish squad to aexos-squads repository (Sprint 8) | full |
| `*sync-squad-cyryx` | Sync squad to AEXOS API marketplace (Sprint 8) | full |
...
commands:
  ...
  - name: download-squad
    visibility: [full]
    description: 'Download public squad from aexos-squads repository (Sprint 8)'
    status: placeholder
  - name: publish-squad
    visibility: [full]
    description: 'Publish squad to aexos-squads repository (Sprint 8)'
    status: placeholder
  - name: sync-squad-cyryx
    visibility: [full]
    description: 'Sync squad to AEXOS API marketplace (Sprint 8)'
    status: placeholder
