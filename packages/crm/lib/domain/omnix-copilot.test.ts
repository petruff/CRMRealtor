...
describe('Omnix copilot fixed grammar', () => {
  it.each([
    ...
    ['workspace overview', { kind: 'workspace-overview' }],
    ['organize my CRM', { kind: 'organization' }],
    ['client status Alicia', { kind: 'client-status', query: 'Alicia' }],
    ["What is Alicia’s deal status?", { kind: 'client-status', query: 'Alicia' }],
    ['transactions for Alicia', { kind: 'transactions', query: 'Alicia' }],
    ['show me my deals', { kind: 'transactions' }],
    ['properties for Alicia', { kind: 'properties', query: 'Alicia' }],
    ['nurture for Alicia', { kind: 'nurture', query: 'Alicia' }],
    ['financials', { kind: 'finances' }],
    ['approvals for Alicia', { kind: 'proposals', query: 'Alicia' }],
    ['Qual é o status de Alicia?', { kind: 'client-status', query: 'Alicia' }],
    ['resumo do CRM', { kind: 'workspace-overview' }],
    ['organize meu CRM', { kind: 'organization' }],
    ['transações de Alicia', { kind: 'transactions', query: 'Alicia' }],
    ['imóveis para Alicia', { kind: 'properties', query: 'Alicia' }],
    ['finanças', { kind: 'finances' }],
