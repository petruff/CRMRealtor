...
export type IconKey =
  ...
  | 'review' | 'import' | 'workspaces' | 'openhouse' | 'sphere' | 'leadpage' | 'listing' | 'revive';
...
export const MORE_SECTIONS: readonly NavSection[] = [
  {
    ...
    links: [
      ...
      { href: '/lead-page', label: 'Lead page', icon: 'leadpage' },
      { href: '/listing-writer', label: 'Listing writer', icon: 'listing' },
      { href: '/revive', label: 'Revive old leads', icon: 'revive' },
