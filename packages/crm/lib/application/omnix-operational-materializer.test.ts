...
describe('Omnix operational materializer', () => {
  ...
  it('turns minimized inbound metadata and verified deadlines into governed actions', () => {
    ...
    expect(proposals[1]).toMatchObject({ transactionId: 'transaction-a', title: 'Inspection deadline', factors: { potentialValueCents: 1_200_000 } });
