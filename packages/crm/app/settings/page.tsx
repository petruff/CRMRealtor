...
import { readWorkspaceAiStatus, type WorkspaceAiStatus } from '@/lib/application/workspace-ai-settings';
...
export default async function SettingsPage() {
  ...
  if (context.isLive) {
    try { status = await readWorkspaceAiStatus(await createSupabaseServerClient(), context.workspaceScope); }
