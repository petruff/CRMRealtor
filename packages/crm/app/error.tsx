...
export default function AppError({ reset }: { error: Error; reset: () => void }) {
  return (
    <section role="alert" className="sk-group bg-surface p-6">
      <h1 className="font-display text-3xl text-ink">This page could not load</h1>
      <p className="mt-3 max-w-xl text-sm leading-relaxed text-muted">Nothing was changed. Retry the secure read or continue to another part of Omnix.</p>
